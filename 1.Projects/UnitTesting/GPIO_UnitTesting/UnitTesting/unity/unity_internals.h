...
/* Duat declare this function to run the test with ONE ADDRESS ARGUMENT */
...
#ifdef __STDC_VERSION__
#if __STDC_VERSION__ >= 199901L
#define RUN_TEST_ON_PORTX(...) UnityTestRunWithAddressArgument(D_RUN_TEST_FIRST(__VA_ARGS__), D_RUN_TEST_SECOND(__VA_ARGS__), D_RUN_TEST_THIRD(__VA_ARGS__))
#define D_RUN_TEST_FIRST(...) D_RUN_TEST_FIRST_HELPER(__VA_ARGS__)
#define D_RUN_TEST_FIRST_HELPER(first, ...) (first), #first
#define D_RUN_TEST_SECOND(...) D_RUN_TEST_SECOND_HELPER(__VA_ARGS__)
#define D_RUN_TEST_SECOND_HELPER(first, second, ...) (second)
#define D_RUN_TEST_THIRD(...) D_RUN_TEST_THIRD_HELPER(__VA_ARGS__, __LINE__)
#define D_RUN_TEST_THIRD_HELPER(first, second, third ...) (third)
#endif
#endif
#endif
